...
const userSchema = new Schema(
  {
    ...
    inviteToken: { type: String, default: null, select: false, index: true, sparse: true },
    inviteExpiresAt: { type: Date, default: null },
    passwordResetToken: { type: String, default: null, select: false, index: true, sparse: true },
