...
import { LayoutDashboard, FileText, ClipboardList, Users, CreditCard, UserPlus, Settings, LogOut, Menu, X } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { to: '/app/participants', label: 'Participants', icon: Users },
